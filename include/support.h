...
//------------------------------------------------------------------------------
// Seta o iterador da fila no último elemento
//
// Ret:
//  == 0, se conseguiu
//  != 0, caso contrário (erro ou fila vazia)
...
//------------------------------------------------------------------------------
// Seta o iterador da fila para o próximo elemento
//
// Ret:
//  == 0, se conseguiu
...
//------------------------------------------------------------------------------
// Retorna o conteúdo do nodo endereçado pelo iterador da lista "pFila"
//
// Ret:
...
//------------------------------------------------------------------------------
// Coloca o ponteiro "content" logo após o elemento //     correntemente apontado pelo iterador da fila "pFila"
//
// Ret:
//  == 0, se conseguiu
//  != 0, caso contrário (erro)
